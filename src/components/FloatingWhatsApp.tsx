...
export default function FloatingWhatsApp() {
  ...
  return (
    <div className="fixed right-5 bottom-7 z-50 flex flex-col items-end gap-3">
      {/* Tooltip label */}
      <AnimatePresence>
        {hovered && (
          <motion.div
            ...
            className="bg-[#1a1a1a] text-white text-xs font-[family-name:var(--font-body)] px-4 py-2 rounded-xl shadow-xl whitespace-nowrap"
          >
